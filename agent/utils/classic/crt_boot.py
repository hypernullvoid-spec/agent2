...
from agent.utils.classic.boot_timing import settle_curve
...
def run_boot_sequence(
    console: Console, boot_lines: list[tuple[str, str]], indent: str = ""
) -> None:
    ...
    Args:
        ...
        indent: Left margin prefixed to every line, so the boot text lands in
            the same centered column as the rest of the UI. It is drawn, never
            typed — the typewriter cadence tracks the text alone.
    """
